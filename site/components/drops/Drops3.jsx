...
import styles from './new2.module.scss'
  ...
  return (
    <group>
      ...
      <group ref={ref} rotation={[0, 0, 0.075 * Math.PI]}>
        <mesh castShadow position={[0.25, 1.55, 0.1]}>
          <boxGeometry args={[1.8, 1.1, 0.01]} />
          <meshStandardMaterial metalness={1} roughness={1} map={closedMap} />
        </mesh>
        <mesh ref={leftCorner} position={[-0.51, 2, 0.11]}>
          <circleGeometry args={[0.02, 12]} />
          <meshStandardMaterial color="black" />
        </mesh>
        <mesh ref={rightCorner} position={[1, 2, 0.11]}>
          <circleGeometry args={[0.02, 12]} />
          <meshStandardMaterial color="black" />
        </mesh>
      </group>
