...
const Grid: FC<Props> = (props) => {
  ...
  return (
    ...
    >
      <CutoutImage {...props} topLeft />
      <CutoutImage {...props} topRight />
      <CutoutImage {...props} bottomRight />
      <CutoutImage {...props} bottomLeft />
    </div>
  )
}

const CutoutImage: FC<Props> = ({
  top,
  left,
  right,
  bottom,
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Image
          src={`/textures/film/film_${useRandom(1, 10)}.png`}
          alt={'film'}
          fill
